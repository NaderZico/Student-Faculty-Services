            ...
            <tbody>
                ...
                while ($appointment = $completedAppointments->fetch_assoc()) {
                    ...
                    echo "</tr>";
                      ...
                      // Hidden form for each appointment
                ...
                echo "<label>
                <input type='radio' name='attendance_status' value='attended' required> 
                The student has attended the appointment
            </label>";
                echo "<label>
                <input type='radio' name='attendance_status' value='unattended' required> 
                The student did not attend the appointment
            </label>";
