    ...
    <div class="section">
        <div class="form">
            ...
            <form id="appointment-form" method="POST" action="handle_appointments.php">
                <div class="field1">
                    <label for="faculty-search">Search Faculty</label><br>
                    <input type="text" name="faculty-search" id="faculty-search" class="faculty-search"
                        placeholder="Search by name..." required oninput="searchFaculty()"
                        >
                        <div id="select-slot-container">
                        <select name="faculty-list" id="faculty-list" class="faculty-list" required>
                            <option class="faculty-id" id="faculty-id" value="">Select Faculty</option>
                        </select>
                    </div>
                </div>
                <div class="field2">
                    <label for="select-slot">Select Slot</label><br>
                    <select name="select-slot" id="select-slot" class="select-slot" required>
