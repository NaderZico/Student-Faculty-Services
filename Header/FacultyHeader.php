        ...
        <div class="web-header">
                    ...
                    <nav id="menu">
                        <ul>
                            <li class="active"> <!-- Add the active class to keep it visible -->
                                <a href="#">Account</a>
                                <ul class="sub-menu">
                                    <li><a href="../ProfilePage/FacultyProfile.php">My Profile</a></li>
                            ...
                            <li class="active"> <!-- Add the active class to keep it visible -->
                                ...
                                <ul class="sub-menu">
                                    <li><a href="../SetSlotsPage/SetSlotsPage.php">Set Slots</a></li>
                                    <li><a href="../SetSlotsPage/ViewSlotsPage.php">View Slots</a></li>
                                    <li><a href="../ViewAppointmentPage/FacultyAppointmentView.php">View Appointments</a></li>
                                </ul>
                            </li>
                        </ul>
            ...
            <div class="web-header-right">
                <div class="notification-btn">
                    ...
                    <div id="unreadCount" class="unread-count"></div>
